data:extend(
{
	
	{
		...
		results = {{type="item", name="y-coal-brikett", amount=1},},
	...
	-- new-coal-things 215-0103
	{
		...
		results = {{type="item", name="y-coal-dust", amount=6},},
		--result = "y-coal-dust", result_count = 6, 
	},
	{
		type = "recipe",
		...
		--result = "y-mixed-fuel", result_count = 1, 
	},
	{
		type = "recipe",
		name = "y-mixfuel-load",
