...
require("prototypes.integration.space-age.e_smelter") -- Smelter updates
require("prototypes.integration.space-age.y-module") -- Update speed modules
require("prototypes.integration.space-age.y_entities") -- Entities updates
require("prototypes.integration.space-age.e_entity216") -- Beacon updates
