if mods["Krastorio2"] then
    ...
    data.raw["recipe"]["y_high-tech_science"].icon = "__Krastorio2Assets__/icons/cards/utility-tech-card.png"
    data.raw["recipe"]["y_space_science"].icon = "__Krastorio2Assets__/icons/cards/optimization-tech-card.png"
end
